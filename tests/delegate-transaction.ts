...
import { IAddDelegateRequest, IAuthorisedRequest, IKeyPairData, ITransferOwnership, ITransferRequest, PlatformClient, PlatformUtils, ProtocolIdType, ICreateAssetRequest, ICreateAssetTypeRequest, ICreateIdentityRequest, ITransferItem, ITransferQuantity, ITransferQuery } from "../iov42/core-sdk";
    ...
    describe(`Testing transaction methods using delegate with protocolId="${input.protocolId}"`, function () {
        ...
        before('Initializing identities, asset types', () => {
            ...
            .then( () => {
                ...
                return platformClient.addDelegate(finalRequest, keyPair1);
            })
            .then( () => {
                const request: IAddDelegateRequest = {
                    _type: "AddDelegateRequest",
                ...
                return platformClient.addDelegate(finalRequest, keyPair2);
            })
            .then( () => {
        ...
        describe("Retrieves transations for unique asset", () => {
            it("should return success", async () => {
                ...
                return platformClient.getTransactions(query, delegateKeyPair, identityId2)
                .then( (response) => {
